...
package com.klisly.bookbox.widget.draglistview;
...
public class DragListView extends FrameLayout {
    ...
    private DragItemRecyclerView createRecyclerView() {
        final DragItemRecyclerView recyclerView = (DragItemRecyclerView) LayoutInflater
                .from(getContext()).inflate(R.layout.drag_item_recycler_view, this, false);
