package com.klisly.bookbox.widget.circlerefresh;
...
public class CircleRefreshLayout extends FrameLayout {
    ...
    private static String TAG = CircleRefreshLayout.class.getSimpleName();
    ...
    /**
     * ValueAnimator （属性动画）提供了一个以时间为基准的动画引擎,用于通过指定最终的属性的值来构成动画的变换.
     * 可以在一次动画中设置多个属性的值,达到配合使用效果
     */
