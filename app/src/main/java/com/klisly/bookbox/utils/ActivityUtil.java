...
public class ActivityUtil {
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager connectivityManager = (ConnectivityManager) BookBoxApplication.getInstance().getApplicationContext().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static void copyToClipBoard(Context context, String text) {
        ...
        ToastHelper.showShortTip("已复制到剪贴板");
    }
...
//    }
    ...
    public static int dp2px(float dpValue) {
        final float scale = BookBoxApplication.getInstance().getResources().getDisplayMetrics().density;
        return (int) (dpValue * scale + 0.5f);
    }
